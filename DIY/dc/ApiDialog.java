...
public class ApiDialog extends BaseDialog {
    ...
    public ApiDialog(@NonNull @NotNull Context context) {
        ...
        //内置网络接口在此处添加
        inputApi.setText(Hawk.get(HawkConfig.API_URL, "https://git.wwz09.top:5555/wwz09/ubuntu/raw/branch/main/TXT/dc.json"));
        liveApi.setText(Hawk.get(HawkConfig.LIVE_URL, "https://git.wwz09.top:5555/wwz09/ubuntu/raw/branch/main/TXT/a.txt"));
...
//        });
    ...
    private void putDefaultApis(String url) {
        ...
        String defaultApi = "https://git.wwz09.top:5555/wwz09/ubuntu/raw/branch/main/main.json";
        // 默认仓库地址
        String defaultStoreApi = "https://git.wwz09.top:5555/wwz09/ubuntu/raw/branch/main/TXT/dc.json";
