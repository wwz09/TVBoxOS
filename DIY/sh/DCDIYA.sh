...
sed -i 's%// Map<String, String> defaultApiMap = Hawk.get(HawkConfig.API_MAP%Map<String, String> defaultApiMap = Hawk.get(HawkConfig.API_MAP%g' app/src/main/java/com/github/tvbox/osc/bbox/base/App.java
