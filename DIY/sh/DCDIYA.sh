...
sed -i 's%https://gitea.com/404ynnub/resource/raw/branch/main/version.json%https://git.wwz09.xin:5555/wwz09/ubuntu/raw/main/main.json%g' app/src/main/java/com/github/tvbox/osc/bbox/constant/URL.java
