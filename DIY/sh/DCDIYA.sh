...
sed -i 's%String GITHUB_VERSION_PATH = "https://gitea.com/404ynnub/resource/raw/branch/main/version.json"%String GITHUB_VERSION_PATH = "https://git.wwz09.xin:5555/wwz09/ubuntu/raw/main/main.json"%g' app/src/main/java/com/github/tvbox/osc/bbox/constant/URL.java
sed -i 's%String DEFAULT_STORE_API_URL = "https://gitea.com/404ynnub/resource/raw/branch/main/boxsource.json"%String GITHUB_VERSION_PATH = "https://git.wwz09.xin:5555/wwz09/ubuntu/raw/branch/main/TXT/dc.json"%g' app/src/main/java/com/github/tvbox/osc/bbox/constant/URL.java
