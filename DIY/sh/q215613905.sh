...
sed -i 's%(HawkConfig.API_URL, "");%(HawkConfig.API_URL, "https://ghfast.top/https://raw.githubusercontent.com/wwz09/ubuntu/main.json");%g' app/src/main/java/com/github/tvbox/osc/api/ApiConfig.java   
