...
sed -i 's%HomeActivity.getRes().getString(R.string.app_source))%"https://ghfast.top/https://raw.githubusercontent.com/wwz09/ubuntu/main.json")% g' app/src/main/java/com/github/tvbox/osc/api/ApiConfig.java
